...
namespace estate_executor{
    ...
    int assemble_code(){
        int allRed;
        int allBlue;
        allRed = zhang::red::code_fragment() + khan::red::code_fragment() + garcia::red::code_fragment();
        allBlue = zhang::blue::code_fragment() + khan::blue::code_fragment() + garcia::blue::code_fragment();
        int integer;
        integer = allRed * allBlue;
        return integer;
    }
}